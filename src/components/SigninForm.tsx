  ...
  return (
    <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl">
      <div className="text-center mb-8">
        ...
        <p className="text-brand-secondary-400">Sign in to your StudioAlign account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <p className="text-center text-sm text-brand-secondary-400">
          ...
          <Link to="/signup" className="font-medium text-brand-primary hover:text-brand-secondary-400">
            Sign up
          </Link>
        </p>
      </form>
