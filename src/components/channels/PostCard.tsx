...
import { MoreVertical, ThumbsUp, MessageCircle, Trash2, Edit2 } from 'lucide-react';
import { formatDistanceToNow } from 'date-fns';
import { useAuth } from '../../contexts/AuthContext';
import { toggleReaction, deletePost, updatePost } from '../../utils/channelUtils';
...
export default function PostCard({ post, isAdmin, channelId }: PostCardProps) {
  ...
  const canModify = isAdmin || post.author_id === userId;
  const hasLiked = post.reactions?.some(reaction => reaction.user_id === userId);
        ...
        <div className="mt-4 flex items-center space-x-4">
          <button
            ...
            className={`flex items-center ${
              hasLiked ? 'text-brand-primary' : 'text-gray-500 hover:text-brand-primary'
            }`}
          >
