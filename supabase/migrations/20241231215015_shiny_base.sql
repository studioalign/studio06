/*
  # Update get_effective_class_details function
  
  1. Changes
    - Drop existing function first to avoid conflicts
    - Add new function with updated return type and proper joins
    - Include additional fields in return type for better data access
*/
